...
class CWLProvider {
  constructor() {
    ...
    this.subscriptions.add(
        atom.config.observe('autocomplete-cwl.biocontainers.suggest', (value) => {
          biocontainersSuggest = value;
        })
    ...
    this.cwlsSource = {
      cwlsForScopes(scopeDescriptor) {
        ...
        // Biocontainers Suggest
        if(biocontainersSuggest){
